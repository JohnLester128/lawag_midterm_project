                ...
                <div class="mb-6 rounded-lg border border-neutral-200 bg-neutral-50 p-6 dark:border-neutral-700 dark:bg-neutral-900/50">
                    ...
                    <form action="{{ route('departments.store') }}" method="POST" class="space-y-4">
                        ...
                        <div class="grid gap-4 md:grid-cols-3">
                            ...
                            <!-- <div class="md:col-span-2">
                                <label class="mb-2 block text-sm font-medium text-neutral-700 dark:text-neutral-300">Goal</label>
                                <textarea name="goal" rows="1" placeholder="Enter department goal"
                                          class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100">{{ old('goal') }}</textarea>
                                @error('goal')
                                    <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div> -->
        ...
        <div class="w-full max-w-2xl rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-800">
            ...
            <form id="editDepartmentForm" method="POST">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <!-- <div class="md:col-span-2">
                        <label class="mb-2 block text-sm font-medium text-neutral-700 dark:text-neutral-300">Goal</label>
                        <textarea id="edit_goal" name="goal" rows="3"
                                  class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100"></textarea>
                    </div> -->
                </div>
